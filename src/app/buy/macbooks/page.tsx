...
const page = () => {
  ...
  const [filteredData, setFilteredData] = useState(dataMacbookList);
  ...
  useEffect(() => {
    const delayDebounce = setTimeout(() => {
      try {
        ...
        const filtered = dataMacbookList.filter((item) => item.model.toLowerCase().includes(searchQuery.toLowerCase()));
