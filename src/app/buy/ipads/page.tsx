...
const page = () => {
  ...
  const [filteredData, setFilteredData] = useState(dataIPadsList);
  ...
  useEffect(() => {
    const delayDebounce = setTimeout(() => {
      try {
        ...
        const filtered = dataIPadsList.filter((item) => item.model.toLowerCase().includes(searchQuery.toLowerCase()));
