  ...
  return (
    <div className="w-full py-12 bg-primary/5 rounded-lg">
      <div className={root_container}>
        <h2 className="text-xl md:text-2xl font-bold  mb-5 px-5 md:px-0">How Sell Service Works</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {steps.map((step) => (
            <div key={step.id} className="px-4 py-2 md:p-8 flex md:flex-col justify-center items-center gap-5">
