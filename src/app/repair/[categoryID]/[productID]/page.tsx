...
const page = () => {
  ...
  const handleSetParams = () => {
    ...
    router.push(`/repair/calculate${params}`);
  };
  ...
  return (
    <div className={`${root_container} p-10`}>
      <h2 className="text-2xl font-semibold text-gray-900 font-heading">Repair Your {productDetails?.product_name}</h2>
      <Breadcrumb />
      {/* <div className=""> */}
