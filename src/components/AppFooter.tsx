    ...
    // },
    {
      ...
      icon: (
        <svg
          ...
          aria-hidden="true"
        >
          <path d="M19.615 7.105a2.673 2.673 0 00-1.88-1.893C16.03 5 12 5 12 5s-4.03 0-5.735.212a2.673 2.673 0 00-1.88 1.893C4 8.814 4 12 4 12s0 3.186.385 4.895a2.673 2.673 0 001.88 1.893C7.97 19 12 19 12 19s4.03 0 5.735-.212a2.673 2.673 0 001.88-1.893C20 15.186 20 12 20 12s0-3.186-.385-4.895zM10 15V9l5 3-5 3z" />
        </svg>
      ),
      label: "Youtube",
    },
